...
async function getProducts(searchParams: any) {
  try {
    ...
    const res = await fetch(
      `${API_URL}/api/products/weekly-sale?${query.toString()}`,
      {
        cache: "no-store",
      },
    );
      ...
      <div className="container mx-auto px-6 max-w-[1600px]">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-20 border-b border-[#0F3A44]/10 dark:border-gray-900 pb-12">
          <div>
            <Link
              href="/"
              className="inline-flex items-center text-[10px] font-black text-[#13A048] hover:text-[#0F3A44] transition-colors mb-6 uppercase tracking-[0.3em]"
            >
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-6 font-medium max-w-xl text-lg leading-relaxed">
              Discover our hand-picked promotions and limited-time deals on your
              favorite grocery and household items!
            </p>
          </div>
        </div>
